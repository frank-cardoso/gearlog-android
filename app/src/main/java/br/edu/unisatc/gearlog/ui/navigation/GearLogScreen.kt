...
sealed class GearLogScreen(val route: String, val title: String, val icon: ImageVector) {
    ...
    object History : GearLogScreen("history", "Histórico", Icons.AutoMirrored.Filled.List)
    ...
    object AddVehicle : GearLogScreen("add_vehicle", "Adicionar Veículo", Icons.Filled.Add)
}
